...
export default function Footer() {
  return (
    <>
      <div className="w-full bg-primary-black dark:bg-primary-black/30 py-16 px-8 lg:px-36 flex flex-col sm:flex-row justify-center gap-8 sm:gap-32 lg:gap-72 xl:gap-80">
        <div className="space-y-6 sm:space-y-10">
          ...
          <p className="text-primary-silver text-sm font-light leading-6">
        ...
        <div className="grid grid-cols-2 xl:grid-cols-3 gap-y-6">
          <div>
            ...
            <div className="mt-4 flex flex-col gap-2.5">
              <a href="#" className="text-primary-silver text-sm font-light">
                About us
              </a>
              <a href="#" className="text-primary-silver text-sm font-light">
                Blog
          ...
          <div>
            ...
            <div className="mt-4 flex  gap-2.5 w-full">
              <div className="flex items-center px-3 bg-[#515b60] w-60 rounded-md relative">
                <input
                  className="flex rounded-md bg-transparent py-3 text-sm outline-none h-10 text-[#D9DBE1]"
                  placeholder="Your email address"
                  type="text"
                />

                <button className="absolute top-0 right-0 py-2 px-3 text-slate-600 flex">
                  <svg
                    width="18"
                    height="18"
                    viewBox="0 0 18 18"
